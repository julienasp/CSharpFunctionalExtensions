...
namespace CSharpFunctionalExtensions
{
    ...
    {
        public static async Task<T> GetValueOrThrowAsync<T>(this Task<Maybe<T>> maybeTask)
        {
        ...
        public static async Task<T> GetValueOrThrowAsync<T>(this Task<Maybe<T>> maybeTask, string errorMessage)
        {
            var maybe = await maybeTask.DefaultAwait();
