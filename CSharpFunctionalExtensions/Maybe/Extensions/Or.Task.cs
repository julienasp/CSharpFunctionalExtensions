...
namespace CSharpFunctionalExtensions
{
    public static partial class MaybeExtensions
    {
        ...
        /// <returns></returns>
        public static async Task<Maybe<T>> OrAsync<T>(this Task<Maybe<T>> maybeTask, Task<T> fallback)
        {
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public static async Task<Maybe<T>> OrAsync<T>(this Task<Maybe<T>> maybeTask, Func<Task<T>> fallbackOperation)
        {
            var maybe = await maybeTask.DefaultAwait();
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public static async Task<Maybe<T>> OrAsync<T>(this Task<Maybe<T>> maybeTask, Func<Maybe<T>> fallbackOperation)
        {
            var maybe = await maybeTask.DefaultAwait();
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public static async Task<Maybe<T>> OrAsync<T>(this Task<Maybe<T>> maybeTask, Func<Task<Maybe<T>>> fallbackOperation)
        {
            var maybe = await maybeTask.DefaultAwait();
