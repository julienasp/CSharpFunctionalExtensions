...
namespace CSharpFunctionalExtensions.ValueTasks
{
    public static partial class AsyncResultExtensionsBothOperands
    {
        ...
        /// </summary>
        public static async ValueTask<Result<K, E>> MapAsync<T, K, E>(this ValueTask<Result<T, E>> resultTask, Func<T, ValueTask<K>> valueTask)
        {
        ...
        ///     Creates a new result from the return value of a given valueTask action. If the calling Result is a failure, a new failure result is returned instead.
        /// </summary>
        public static async ValueTask<Result<K, E>> MapAsync<K, E>(this ValueTask<UnitResult<E>> resultTask, Func<ValueTask<K>> valueTask) 
        {
        ...
        ///     Creates a new result from the return value of a given valueTask action. If the calling Result is a failure, a new failure result is returned instead.
        /// </summary>
        public static async ValueTask<Result<K>> MapAsync<K>(this ValueTask<Result> resultTask, Func<ValueTask<K>> valueTask)
        {
